;; Configuration for nXhtml mode, the emacs web-development package.
...
(setq php-manual-path "~/emacs/doc/php/")
(setq php-completion-file "~/emacs/doc/php_completion_file")
